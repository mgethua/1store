    ...
    return {
        ...
        event: function () {
            ...
            this.$showImage.onmouseenter = function () {
                ...
                _this.$showBigImage.querySelector('img').style.height = this.offsetHeight * _this.Multiple + 'px';
            }
        ...
        showImage: function (index) {
            ...
            this.$showImage.querySelector('img').src = src.replace('zuismall', 'small');
            this.$showBigImage.querySelector('img').src = src.replace('zuismall', 'big');
        }
    }
